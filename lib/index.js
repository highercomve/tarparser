...
/**
 * Represents a file or directory in a TAR archive.
 * @typedef {Object} TarFileItem
 * @property {string} name - File name.
 * @property {string} size - File size.
 * @property {string} type - File type.
 * @property {Uint8Array} [data] - File data (don't provide for directories).
 * @property {TarFileAttrs} [attrs] - File attributes.
 */

/**
 * Represents a parsed file item in the TAR archive.
 * @typedef {TarFileItem & { type: "file" | "directory" | number, size: number, text: string }} ParsedTarFileItem
 */

/**
 * Represents the attributes of a file or directory in the TAR archive.
 * @typedef {Object} TarFileAttrs
 * @property {string} [mode] - Default: 664 (-rw-rw-r--) for files and 775 (-rwxrwxr-x) for directories.
 * @property {number} [uid] - Default: 1000.
 * @property {number} [gid] - Default: 1000.
 * @property {number} [mtime] - Default: Date.now().
 * @property {string} [user] - Default: "".
 * @property {string} [group] - Default: "".
 */

/**
 * Parses a TAR archive from an ArrayBuffer or Uint8Array.
 * @param {ArrayBuffer|Uint8Array} data - The binary data of the TAR archive.
 * @returns {Promise<TarFileItem[]>} - An array of objects representing the parsed TAR contents.
 */
...
/**
 * Main function to check file type using a buffer
